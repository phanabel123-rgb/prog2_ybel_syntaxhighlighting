...
class RegexHighlighterTest {
    ...
    public void testSimpleCasesWithoutOverlaps() {
        ...
        assertEquals(2, resolvedMatches.size(),
            "Beide konfliktfreien Keywords müssen erhalten bleiben.");
    ...
    public void testOverlappingKeywordInsideComment() {
        ...
        assertEquals(1, resolvedMatches.size(),
    ...
    public void testAdjacentRegions() {
        ...
        assertEquals(2, resolved.size(),
            "Direkt aufeinanderfolgende Regionen (Grenzberührung) überlappen nicht und müssen beide bleiben.");
